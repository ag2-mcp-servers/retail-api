...
class GoogleCloudRetailLoggingImportErrorContext(BaseModel):
    catalogItem: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2AddFulfillmentPlacesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2AddFulfillmentPlacesResponse(BaseModel):
    pass


class GoogleCloudRetailV2AddLocalInventoriesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2AddLocalInventoriesResponse(BaseModel):
    pass
...
class GoogleCloudRetailV2ImportMetadata(BaseModel):
    ...
    requestId: Optional[str] = Field(
        None, description='Deprecated. This field is never set.'
    )
...
class PeriodicTuningState(Enum):
...
class GoogleCloudRetailV2RejoinUserEventsMetadata(BaseModel):
    pass
...
class GoogleCloudRetailV2RemoveFulfillmentPlacesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2RemoveFulfillmentPlacesResponse(BaseModel):
    pass


class GoogleCloudRetailV2RemoveLocalInventoriesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2RemoveLocalInventoriesResponse(BaseModel):
    pass


class GoogleCloudRetailV2SetInventoryMetadata(BaseModel):
    pass


class GoogleCloudRetailV2SetInventoryResponse(BaseModel):
    pass
...
class GoogleCloudRetailV2TuneModelResponse(BaseModel):
    pass
...
class GoogleCloudRetailV2alphaAddControlRequest(BaseModel):
    controlId: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaAddFulfillmentPlacesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2alphaAddFulfillmentPlacesRequest(BaseModel):
    addTime: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaAddFulfillmentPlacesResponse(BaseModel):
    pass


class GoogleCloudRetailV2alphaAddLocalInventoriesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2alphaAddLocalInventoriesResponse(BaseModel):
    pass
...
class GoogleCloudRetailV2alphaAudience(BaseModel):
    ageGroups: Optional[List[str]] = Field(
        None,
...
class GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesRequest(BaseModel):
    attributeKeys: Optional[List[str]] = Field(
        None,
...
class GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesResponse(BaseModel):
    deletedCatalogAttributes: Optional[List[str]] = Field(
        None,
        description='Catalog attributes that were deleted. Only pre-loaded catalog attributes that are neither in use by products nor predefined can be deleted.',
    )
    resetCatalogAttributes: Optional[List[str]] = Field(
        None,
        description='Catalog attributes that were reset. Catalog attributes that are either in use by products or are predefined attributes cannot be deleted; however, their configuration properties will reset to default values upon removal request.',
    )
...
class GoogleCloudRetailV2alphaBigQueryOutputResult(BaseModel):
    ...
    tableId: Optional[str] = Field(None, description='The ID of a BigQuery Table.')


class DynamicFacetableOption(Enum):
...
class ExactSearchableOption(Enum):
...
class RecommendationsFilteringOption(Enum):
    RECOMMENDATIONS_FILTERING_OPTION_UNSPECIFIED = (
        'RECOMMENDATIONS_FILTERING_OPTION_UNSPECIFIED'
    )
    RECOMMENDATIONS_FILTERING_DISABLED = 'RECOMMENDATIONS_FILTERING_DISABLED'
...
class GoogleCloudRetailV2alphaCatalogAttribute(BaseModel):
    dynamicFacetableOption: Optional[DynamicFacetableOption] = Field(
        None,
    ...
    exactSearchableOption: Optional[ExactSearchableOption] = Field(
        None,
    ...
    indexableOption: Optional[IndexableOption] = Field(
        None,
    ...
    recommendationsFilteringOption: Optional[RecommendationsFilteringOption] = Field(
        None,
        description='When AttributesConfig.attribute_config_level is CATALOG_LEVEL_ATTRIBUTE_CONFIG, if RECOMMENDATIONS_FILTERING_ENABLED, attribute values are filterable for recommendations. This option works for categorical features only, does not work for numerical features, inventory filtering.',
    )
    retrievableOption: Optional[RetrievableOption] = Field(
        None,
    ...
    searchableOption: Optional[SearchableOption] = Field(
        None,
...
class GoogleCloudRetailV2alphaColorInfo(BaseModel):
    colorFamilies: Optional[List[str]] = Field(
        None,
...
class GoogleCloudRetailV2alphaCompleteQueryResponseAttributeResult(BaseModel):
    suggestions: Optional[List[str]] = Field(
        None, description='The list of suggestions for the attribute.'
    )


class GoogleCloudRetailV2alphaCompleteQueryResponseRecentSearchResult(BaseModel):
    recentSearch: Optional[str] = Field(None, description='The recent search query.')


class GoogleCloudRetailV2alphaCompletionDetail(BaseModel):
    completionAttributionToken: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaConditionQueryTerm(BaseModel):
    fullMatch: Optional[bool] = Field(
        None, description='Whether this is supposed to be a full or partial match.'
    )
...
class GoogleCloudRetailV2alphaConditionTimeRange(BaseModel):
    endTime: Optional[str] = Field(
        None, description='End of time range. Range is inclusive.'
    )
    startTime: Optional[str] = Field(
        None, description='Start of time range. Range is inclusive.'
    )


class SearchSolutionUseCaseEnum(Enum):
...
class GoogleCloudRetailV2alphaExperimentInfoServingConfigExperiment(BaseModel):
    experimentServingConfig: Optional[str] = Field(
        None,
        description='The fully qualified resource name of the serving config VariantArm.serving_config_id responsible for generating the search response. For example: `projects/*/locations/*/catalogs/*/servingConfigs/*`.',
    )
    originalServingConfig: Optional[str] = Field(
        None,
        description='The fully qualified resource name of the original SearchRequest.placement in the search request prior to reassignment by experiment API. For example: `projects/*/locations/*/catalogs/*/servingConfigs/*`.',
    )
...
class GoogleCloudRetailV2alphaGcsOutputResult(BaseModel):
    outputUri: Optional[str] = Field(None, description='The uri of Gcs output')
...
class GoogleCloudRetailV2alphaGetDefaultBranchResponse(BaseModel):
    ...
    setTime: Optional[str] = Field(
        None, description='The time when this branch is set to default.'
    )
...
class GoogleCloudRetailV2alphaInterval(BaseModel):
    exclusiveMaximum: Optional[float] = Field(
        None, description='Exclusive upper bound.'
    )
    exclusiveMinimum: Optional[float] = Field(
        None, description='Exclusive lower bound.'
    )
    maximum: Optional[float] = Field(None, description='Inclusive upper bound.')
    minimum: Optional[float] = Field(None, description='Inclusive lower bound.')
...
class GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter(
    ...
    primaryFeedId: Optional[str] = Field(
        None, description='Merchant Center primary feed ID.'
    )
    primaryFeedName: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaMerchantCenterLink(BaseModel):
    ...
    feeds: Optional[List[GoogleCloudRetailV2alphaMerchantCenterFeedFilter]] = Field(
        None,
    ...
    merchantCenterAccountId: Optional[str] = Field(
        None,
    ...
    regionCode: Optional[str] = Field(
        None,
        description='Region code of offers to accept. 2-letter Uppercase ISO 3166-1 alpha-2 code. List of values can be found [here](https://www.iana.org/assignments/language-subtag-registry/language-subtag-registry) under the `region` tag. If left blank no region filtering will be performed. Example value: `US`.',
    )


class GoogleCloudRetailV2alphaMerchantCenterLinkingConfig(BaseModel):
    links: Optional[List[GoogleCloudRetailV2alphaMerchantCenterLink]] = Field(
        None, description='Links between Merchant Center accounts and branches.'
    )
...
class GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidate(BaseModel):
    servingConfigId: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaModelPageOptimizationConfigPanel(BaseModel):
    ...
    ] = Field(None, description='Required. The candidates to consider on the panel.')
    defaultCandidate: Optional[
    ...
    displayName: Optional[str] = Field(
        None, description='Optional. The name to display for the panel.'
    )
...
class GoogleCloudRetailV2alphaOutputResult(BaseModel):
    bigqueryResult: Optional[List[GoogleCloudRetailV2alphaBigQueryOutputResult]] = (
        Field(None, description='The BigQuery location where the result is stored.')
    )
    gcsResult: Optional[List[GoogleCloudRetailV2alphaGcsOutputResult]] = Field(
        None,
        description='The Google Cloud Storage location where the result is stored.',
    )


class GoogleCloudRetailV2alphaPauseModelRequest(BaseModel):
    pass


class GoogleCloudRetailV2alphaPredictResponsePredictionResult(BaseModel):
    id: Optional[str] = Field(None, description='ID of the recommended product')
...
class GoogleCloudRetailV2alphaPriceInfoPriceRange(BaseModel):
    originalPrice: Optional[GoogleCloudRetailV2alphaInterval] = Field(
        None,
    ...
    price: Optional[GoogleCloudRetailV2alphaInterval] = Field(
        None,
...
class GoogleCloudRetailV2alphaProductLevelConfig(BaseModel):
    ingestionProductType: Optional[str] = Field(
        None,
    ...
    merchantCenterProductIdField: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaPurgeMetadata(BaseModel):
    pass
...
class GoogleCloudRetailV2alphaPurgeProductsMetadata(BaseModel):
    ...
    successCount: Optional[str] = Field(
        None, description='Count of entries that were deleted successfully.'
    )
    updateTime: Optional[str] = Field(
        None,
        description='Operation last update time. If the operation is done, this is also the finish time.',
...
class GoogleCloudRetailV2alphaRating(BaseModel):
    averageRating: Optional[float] = Field(
        None,
    ...
    ratingHistogram: Optional[List[int]] = Field(
        None,
...
class GoogleCloudRetailV2alphaRejoinUserEventsMetadata(BaseModel):
    pass
...
class GoogleCloudRetailV2alphaRemoveFulfillmentPlacesMetadata(BaseModel):
    pass
...
class GoogleCloudRetailV2alphaRemoveFulfillmentPlacesResponse(BaseModel):
    pass


class GoogleCloudRetailV2alphaRemoveLocalInventoriesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2alphaRemoveLocalInventoriesRequest(BaseModel):
    allowMissing: Optional[bool] = Field(
        None,
...
class GoogleCloudRetailV2alphaRemoveLocalInventoriesResponse(BaseModel):
    pass


class GoogleCloudRetailV2alphaReplaceCatalogAttributeRequest(BaseModel):
    catalogAttribute: Optional[GoogleCloudRetailV2alphaCatalogAttribute] = Field(
        None, description='Required. The updated CatalogAttribute.'
    )
...
class GoogleCloudRetailV2alphaResumeModelRequest(BaseModel):
    pass
...
class GoogleCloudRetailV2alphaRuleBoostAction(BaseModel):
    ...
    productsFilter: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaRuleDoNotAssociateAction(BaseModel):
    ...
    terms: Optional[List[str]] = Field(
        None, description='Will be [deprecated = true] post migration;'
    )
...
class GoogleCloudRetailV2alphaRuleIgnoreAction(BaseModel):
    ignoreTerms: Optional[List[str]] = Field(
        None, description='Terms to ignore in the search query.'
    )


class GoogleCloudRetailV2alphaRuleOnewaySynonymsAction(BaseModel):
    onewayTerms: Optional[List[str]] = Field(
        None, description='Will be [deprecated = true] post migration;'
    )
    queryTerms: Optional[List[str]] = Field(
        None,
...
class GoogleCloudRetailV2alphaRuleRedirectAction(BaseModel):
    redirectUri: Optional[str] = Field(
        None, description='URL must have length equal or less than 2000 characters.'
    )
...
class GoogleCloudRetailV2alphaRuleReplacementAction(BaseModel):
    ...
    replacementTerm: Optional[str] = Field(
        None, description='Term that will be used for replacement.'
    )
...
class GoogleCloudRetailV2alphaRuleTwowaySynonymsAction(BaseModel):
    synonyms: Optional[List[str]] = Field(
        None,
...
class GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec(BaseModel):
...
class GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey(BaseModel):
    ...
    intervals: Optional[List[GoogleCloudRetailV2alphaInterval]] = Field(
        None,
    ...
    restrictedValues: Optional[List[str]] = Field(
        None,
    ...
    returnMinMax: Optional[bool] = Field(
        None,
...
class GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec(BaseModel):
    mode: Optional[Mode1] = Field(None, description='Defaults to Mode.AUTO.')
...
class GoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec(BaseModel):
    ...
    pinUnexpandedResults: Optional[bool] = Field(
        None,
...
class GoogleCloudRetailV2alphaSearchResponseFacetFacetValue(BaseModel):
    count: Optional[str] = Field(
        None, description='Number of items that have this facet value.'
    )
    interval: Optional[GoogleCloudRetailV2alphaInterval] = Field(
        None,
...
class GoogleCloudRetailV2alphaSearchResponseQueryExpansionInfo(BaseModel):
    expandedQuery: Optional[bool] = Field(
        None, description='Bool describing whether query expansion has occurred.'
    )
    pinnedResultCount: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaServingConfig(BaseModel):
    boostControlIds: Optional[List[str]] = Field(
        None,
    ...
    diversityLevel: Optional[str] = Field(
        None,
    ...
    diversityType: Optional[DiversityType] = Field(
        None,
    ...
    doNotAssociateControlIds: Optional[List[str]] = Field(
        None,
    ...
    enableCategoryFilterLevel: Optional[str] = Field(
        None,
    ...
    facetControlIds: Optional[List[str]] = Field(
        None,
    ...
    filterControlIds: Optional[List[str]] = Field(
        None,
    ...
    ignoreControlIds: Optional[List[str]] = Field(
        None,
    ...
    onewaySynonymsControlIds: Optional[List[str]] = Field(
        None,
    ...
    priceRerankingLevel: Optional[str] = Field(
        None,
    ...
    redirectControlIds: Optional[List[str]] = Field(
        None,
    ...
    replacementControlIds: Optional[List[str]] = Field(
        None,
    ...
    solutionTypes: Optional[List[SolutionType]] = Field(
        None,
    ...
    twowaySynonymsControlIds: Optional[List[str]] = Field(
        None,
...
class GoogleCloudRetailV2alphaSetDefaultBranchRequest(BaseModel):
    branchId: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaSetInventoryMetadata(BaseModel):
    pass


class GoogleCloudRetailV2alphaSetInventoryResponse(BaseModel):
    pass


class GoogleCloudRetailV2alphaTransformedUserEventsMetadata(BaseModel):
    sourceEventsCount: Optional[str] = Field(
        None, description='Count of entries in the source user events BigQuery table.'
    )
    transformedEventsCount: Optional[str] = Field(
        None,
...
class GoogleCloudRetailV2alphaTuneModelRequest(BaseModel):
    pass


class GoogleCloudRetailV2alphaTuneModelResponse(BaseModel):
    pass
...
class GoogleCloudRetailV2betaAddFulfillmentPlacesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2betaAddFulfillmentPlacesResponse(BaseModel):
    pass


class GoogleCloudRetailV2betaAddLocalInventoriesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2betaAddLocalInventoriesResponse(BaseModel):
    pass
...
class GoogleCloudRetailV2betaOutputResult(BaseModel):
    bigqueryResult: Optional[List[GoogleCloudRetailV2betaBigQueryOutputResult]] = Field(
        None, description='The BigQuery location where the result is stored.'
    )
    gcsResult: Optional[List[GoogleCloudRetailV2betaGcsOutputResult]] = Field(
        None,
        description='The Google Cloud Storage location where the result is stored.',
    )


class GoogleCloudRetailV2betaPurgeMetadata(BaseModel):
    pass
...
class GoogleCloudRetailV2betaRejoinUserEventsMetadata(BaseModel):
    pass
...
class GoogleCloudRetailV2betaRemoveFulfillmentPlacesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2betaRemoveFulfillmentPlacesResponse(BaseModel):
    pass


class GoogleCloudRetailV2betaRemoveLocalInventoriesMetadata(BaseModel):
    pass


class GoogleCloudRetailV2betaRemoveLocalInventoriesResponse(BaseModel):
    pass


class GoogleCloudRetailV2betaSetInventoryMetadata(BaseModel):
    pass


class GoogleCloudRetailV2betaSetInventoryResponse(BaseModel):
    pass
...
class GoogleCloudRetailV2betaTuneModelResponse(BaseModel):
    pass
...
class GoogleCloudRetailLoggingErrorContext(BaseModel):
    httpRequest: Optional[GoogleCloudRetailLoggingHttpRequestContext] = Field(
        None,
        description='The HTTP request which was processed when the error was triggered.',
    )
    reportLocation: Optional[GoogleCloudRetailLoggingSourceLocation] = Field(
        None,
...
class GoogleCloudRetailLoggingErrorLog(BaseModel):
    context: Optional[GoogleCloudRetailLoggingErrorContext] = Field(
        None, description='A description of the context in which the error occurred.'
    )
    importPayload: Optional[GoogleCloudRetailLoggingImportErrorContext] = Field(
    ...
    serviceContext: Optional[GoogleCloudRetailLoggingServiceContext] = Field(
...
class GoogleCloudRetailV2ImportProductsResponse(BaseModel):
    ...
    errorsConfig: Optional[GoogleCloudRetailV2ImportErrorsConfig] = Field(
        None,
...
class GoogleCloudRetailV2ImportUserEventsResponse(BaseModel):
    ...
    importSummary: Optional[GoogleCloudRetailV2UserEventImportSummary] = Field(
        None, description='Aggregated statistics of user event import status.'
    )
...
class GoogleCloudRetailV2Model(BaseModel):
    ...
    filteringOption: Optional[FilteringOption] = Field(
        None,
    ...
    lastTuneTime: Optional[str] = Field(
        None,
    ...
    periodicTuningState: Optional[PeriodicTuningState] = Field(
        None,
...
class GoogleCloudRetailV2alphaAddCatalogAttributeRequest(BaseModel):
    catalogAttribute: Optional[GoogleCloudRetailV2alphaCatalogAttribute] = Field(
        None, description='Required. The CatalogAttribute to add.'
    )


class GoogleCloudRetailV2alphaAttributesConfig(BaseModel):
    attributeConfigLevel: Optional[AttributeConfigLevel] = Field(
        None, description='Output only. The AttributeConfigLevel used for this catalog.'
    )
    catalogAttributes: Optional[Dict[str, GoogleCloudRetailV2alphaCatalogAttribute]] = (
        Field(
            None,
...
class GoogleCloudRetailV2alphaCatalog(BaseModel):
    ...
    merchantCenterLinkingConfig: Optional[
    ...
    productLevelConfig: Optional[GoogleCloudRetailV2alphaProductLevelConfig] = Field(
        None, description='Required. The product level configuration.'
    )


class GoogleCloudRetailV2alphaCompletionDataInputConfig(BaseModel):
    bigQuerySource: Optional[GoogleCloudRetailV2alphaBigQuerySource] = Field(
        None,
...
class GoogleCloudRetailV2alphaCondition(BaseModel):
    activeTimeRange: Optional[List[GoogleCloudRetailV2alphaConditionTimeRange]] = Field(
        None,
        description='Range of time(s) specifying when Condition is active. Condition true if any time range matches.',
    )
    queryTerms: Optional[List[GoogleCloudRetailV2alphaConditionQueryTerm]] = Field(
        None,
...
class GoogleCloudRetailV2alphaExperimentInfo(BaseModel):
    experiment: Optional[str] = Field(
        None,
        description='The fully qualified resource name of the experiment that provides the serving config under test, should an active experiment exist. For example: `projects/*/locations/global/catalogs/default_catalog/experiments/experiment_id`',
    )
    servingConfigExperiment: Optional[
        GoogleCloudRetailV2alphaExperimentInfoServingConfigExperiment
    ] = Field(
        None,
        description='A/B test between existing Cloud Retail Search ServingConfigs.',
    )
...
class GoogleCloudRetailV2alphaExportProductsResponse(BaseModel):
    ...
    errorsConfig: Optional[GoogleCloudRetailV2alphaExportErrorsConfig] = Field(
        None, description='This field is never set.'
    )
    outputResult: Optional[GoogleCloudRetailV2alphaOutputResult] = Field(
        None, description='Output result indicating where the data were exported to.'
    )
...
class GoogleCloudRetailV2alphaImportCompletionDataRequest(BaseModel):
    inputConfig: Optional[GoogleCloudRetailV2alphaCompletionDataInputConfig] = Field(
...
class GoogleCloudRetailV2alphaImportMetadata(BaseModel):
    ...
    transformedUserEventsMetadata: Optional[
        GoogleCloudRetailV2alphaTransformedUserEventsMetadata
    ] = Field(None, description='Metadata related to transform user events.')
    updateTime: Optional[str] = Field(
        None,
        description='Operation last update time. If the operation is done, this is also the finish time.',
    )
...
class GoogleCloudRetailV2alphaImportProductsResponse(BaseModel):
    ...
    errorsConfig: Optional[GoogleCloudRetailV2alphaImportErrorsConfig] = Field(
        None,
        description='Echoes the destination for the complete errors in the request if set.',
    )
...
class GoogleCloudRetailV2alphaImportUserEventsResponse(BaseModel):
    ...
    importSummary: Optional[GoogleCloudRetailV2alphaUserEventImportSummary] = Field(
        None, description='Aggregated statistics of user event import status.'
    )


class GoogleCloudRetailV2alphaListCatalogsResponse(BaseModel):
    catalogs: Optional[List[GoogleCloudRetailV2alphaCatalog]] = Field(
        None, description="All the customer's Catalogs."
    )
...
class GoogleCloudRetailV2alphaListServingConfigsResponse(BaseModel):
    nextPageToken: Optional[str] = Field(
        None, description='Pagination token, if not returned indicates the last page.'
    )
    servingConfigs: Optional[List[GoogleCloudRetailV2alphaServingConfig]] = Field(
        None, description='All the ServingConfigs for a given catalog.'
    )
...
class GoogleCloudRetailV2alphaMerchantCenterAccountLink(BaseModel):
    ...
    feedFilters: Optional[
        List[GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter]
    ] = Field(
        None,
        description='Criteria for the Merchant Center feeds to be ingested via the link. All offers will be ingested if the list is empty. Otherwise the offers will be ingested from selected feeds.',
    )
    ...
    projectId: Optional[str] = Field(
        None, description='Output only. Google Cloud project ID.'
    )
    state: Optional[State] = Field(
        None, description='Output only. Represents the state of the link.'
    )


class GoogleCloudRetailV2alphaModelPageOptimizationConfig(BaseModel):
    pageOptimizationEventType: Optional[str] = Field(
        None,
    ...
    panels: Optional[List[GoogleCloudRetailV2alphaModelPageOptimizationConfigPanel]] = (
        Field(None, description='Required. A list of panel configurations. Limit = 5.')
    )
...
class GoogleCloudRetailV2alphaPredictResponse(BaseModel):
    ...
    results: Optional[List[GoogleCloudRetailV2alphaPredictResponsePredictionResult]] = (
        Field(
            None,
    ...
    validateOnly: Optional[bool] = Field(
        None, description='True if the validateOnly property was set in the request.'
    )
...
class GoogleCloudRetailV2alphaPriceInfo(BaseModel):
    ...
    priceEffectiveTime: Optional[str] = Field(
        None,
    ...
    priceExpireTime: Optional[str] = Field(
        None,
    ...
    priceRange: Optional[GoogleCloudRetailV2alphaPriceInfoPriceRange] = Field(
        None,
...
class GoogleCloudRetailV2alphaRule(BaseModel):
    boostAction: Optional[GoogleCloudRetailV2alphaRuleBoostAction] = Field(
        None, description='A boost action.'
    )
    condition: Optional[GoogleCloudRetailV2alphaCondition] = Field(
        None,
        description='Required. The condition that triggers the rule. If the condition is empty, the rule will always apply.',
    )
    doNotAssociateAction: Optional[GoogleCloudRetailV2alphaRuleDoNotAssociateAction] = (
        Field(None, description='Prevents term from being associated with other terms.')
    )
    filterAction: Optional[GoogleCloudRetailV2alphaRuleFilterAction] = Field(
        None, description='Filters results.'
    )
    ignoreAction: Optional[GoogleCloudRetailV2alphaRuleIgnoreAction] = Field(
        None, description='Ignores specific terms from query during search.'
    )
    onewaySynonymsAction: Optional[GoogleCloudRetailV2alphaRuleOnewaySynonymsAction] = (
        Field(
            None,
    ...
    redirectAction: Optional[GoogleCloudRetailV2alphaRuleRedirectAction] = Field(
        None, description='Redirects a shopper to a specific page.'
    )
    replacementAction: Optional[GoogleCloudRetailV2alphaRuleReplacementAction] = Field(
        None, description='Replaces specific terms in the query.'
    )
    twowaySynonymsAction: Optional[GoogleCloudRetailV2alphaRuleTwowaySynonymsAction] = (
        Field(None, description='Treats a set of terms as synonyms of one another.')
    )


class GoogleCloudRetailV2alphaSearchRequestBoostSpec(BaseModel):
    conditionBoostSpecs: Optional[
        List[GoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec]
    ] = Field(
        None,
    ...
    skipBoostSpecValidation: Optional[bool] = Field(
        None,
...
class GoogleCloudRetailV2alphaSearchRequestFacetSpec(BaseModel):
    enableDynamicPosition: Optional[bool] = Field(
        None,
    ...
    excludedFilterKeys: Optional[List[str]] = Field(
        None,
    ...
    facetKey: Optional[GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey] = Field(
        None, description='Required. The facet key specification.'
    )
...
class GoogleCloudRetailV2alphaSearchResponseFacet(BaseModel):
    dynamicFacet: Optional[bool] = Field(
        None, description='Whether the facet is dynamically generated.'
    )
    key: Optional[str] = Field(
        None,
        description='The key for this facet. E.g., "colorFamilies" or "price" or "attributes.attr1".',
    )
    values: Optional[List[GoogleCloudRetailV2alphaSearchResponseFacetFacetValue]] = (
        Field(None, description='The facet values for this field.')
    )
...
class GoogleCloudRetailV2betaExportProductsResponse(BaseModel):
    ...
    errorsConfig: Optional[GoogleCloudRetailV2betaExportErrorsConfig] = Field(
        None, description='This field is never set.'
    )
    outputResult: Optional[GoogleCloudRetailV2betaOutputResult] = Field(
        None, description='Output result indicating where the data were exported to.'
    )
...
class GoogleCloudRetailV2betaImportProductsResponse(BaseModel):
    ...
    errorsConfig: Optional[GoogleCloudRetailV2betaImportErrorsConfig] = Field(
        None,
        description='Echoes the destination for the complete errors in the request if set.',
    )
...
class GoogleCloudRetailV2betaImportUserEventsResponse(BaseModel):
    ...
    importSummary: Optional[GoogleCloudRetailV2betaUserEventImportSummary] = Field(
        None, description='Aggregated statistics of user event import status.'
    )
...
class GoogleCloudRetailV2betaMerchantCenterAccountLink(BaseModel):
    ...
    feedFilters: Optional[
        List[GoogleCloudRetailV2betaMerchantCenterAccountLinkMerchantCenterFeedFilter]
    ] = Field(
        None,
        description='Criteria for the Merchant Center feeds to be ingested via the link. All offers will be ingested if the list is empty. Otherwise the offers will be ingested from selected feeds.',
    )
...
class GoogleCloudRetailV2betaModel(BaseModel):
    ...
    servingConfigLists: Optional[
        List[GoogleCloudRetailV2betaModelServingConfigList]
    ] = Field(
        None,
        description='Output only. The list of valid serving configs associated with the PageOptimizationConfig.',
    )
...
class GoogleCloudRetailV2alphaCompleteQueryResponseCompletionResult(BaseModel):
    attributes: Optional[Dict[str, GoogleCloudRetailV2alphaCustomAttribute]] = Field(
        None,
    ...
    facets: Optional[List[GoogleCloudRetailV2alphaSearchResponseFacet]] = Field(
        None,
        description='Facet information for the suggestion term. Gives the number of items resulting from a search with this suggestion term for each facet. This is an experimental feature for limited customers. If you want to receive this facet information, reach out to the Retail support team.',
    )
    suggestion: Optional[str] = Field(None, description='The suggestion for the query.')
    totalProductCount: Optional[int] = Field(
        None,
        description='Total number of products associated with a search with this suggestion. This is an experimental feature for limited customers. If you want to receive this product count information, reach out to the Retail support team.',
    )


class GoogleCloudRetailV2alphaCompletionConfig(BaseModel):
    allowlistInputConfig: Optional[
    ...
    autoLearning: Optional[bool] = Field(
        None,
    ...
    denylistInputConfig: Optional[GoogleCloudRetailV2alphaCompletionDataInputConfig] = (
        Field(
            None,
            description='Output only. The source data for the latest import of the autocomplete denylist phrases.',
        )
    )
    lastAllowlistImportOperation: Optional[str] = Field(
        None,
    ...
    lastDenylistImportOperation: Optional[str] = Field(
        None,
    ...
    lastSuggestionsImportOperation: Optional[str] = Field(
        None,
    ...
    matchingOrder: Optional[str] = Field(
        None,
    ...
    maxSuggestions: Optional[int] = Field(
        None,
    ...
    minPrefixLength: Optional[int] = Field(
        None,
    ...
    suggestionsInputConfig: Optional[
        GoogleCloudRetailV2alphaCompletionDataInputConfig
    ] = Field(
        None,
...
class GoogleCloudRetailV2alphaControl(BaseModel):
    associatedServingConfigIds: Optional[List[str]] = Field(
        None,
    ...
    facetSpec: Optional[GoogleCloudRetailV2alphaSearchRequestFacetSpec] = Field(
        None,
    ...
    rule: Optional[GoogleCloudRetailV2alphaRule] = Field(
        None,
    ...
    searchSolutionUseCase: Optional[List[SearchSolutionUseCaseEnum]] = Field(
        None,
...
class GoogleCloudRetailV2alphaListControlsResponse(BaseModel):
    controls: Optional[List[GoogleCloudRetailV2alphaControl]] = Field(
        None, description='All the Controls for a given catalog.'
    )
    nextPageToken: Optional[str] = Field(
        None, description='Pagination token, if not returned indicates the last page.'
    )
...
class GoogleCloudRetailV2alphaListMerchantCenterAccountLinksResponse(BaseModel):
    merchantCenterAccountLinks: Optional[
        List[GoogleCloudRetailV2alphaMerchantCenterAccountLink]
    ] = Field(None, description='The links.')
...
class GoogleCloudRetailV2alphaLocalInventory(BaseModel):
    ...
    fulfillmentTypes: Optional[List[str]] = Field(
        None,
    ...
    placeId: Optional[str] = Field(
        None, description='The place ID for the current set of inventory information.'
    )
    priceInfo: Optional[GoogleCloudRetailV2alphaPriceInfo] = Field(
        None,
...
class GoogleCloudRetailV2alphaModel(BaseModel):
    ...
    pageOptimizationConfig: Optional[
        GoogleCloudRetailV2alphaModelPageOptimizationConfig
    ] = Field(None, description='Optional. The page optimization config.')
    periodicTuningState: Optional[PeriodicTuningState] = Field(
        None,
        description='Optional. The state of periodic tuning. The period we use is 3 months - to do a one-off tune earlier use the `TuneModel` method. Default value is `PERIODIC_TUNING_ENABLED`.',
    )
    servingConfigLists: Optional[
        List[GoogleCloudRetailV2alphaModelServingConfigList]
    ] = Field(
        None,
        description='Output only. The list of valid serving configs associated with the PageOptimizationConfig.',
    )
...
class GoogleCloudRetailV2alphaProduct(BaseModel):
    ...
    audience: Optional[GoogleCloudRetailV2alphaAudience] = Field(
        None,
    ...
    availableQuantity: Optional[int] = Field(
        None, description='The available quantity of the item.'
    )
    availableTime: Optional[str] = Field(
        None,
    ...
    collectionMemberIds: Optional[List[str]] = Field(
        None,
    ...
    colorInfo: Optional[GoogleCloudRetailV2alphaColorInfo] = Field(
        None,
    ...
    fulfillmentInfo: Optional[List[GoogleCloudRetailV2alphaFulfillmentInfo]] = Field(
        None,
    ...
    images: Optional[List[GoogleCloudRetailV2alphaImage]] = Field(
        None,
    ...
    localInventories: Optional[List[GoogleCloudRetailV2alphaLocalInventory]] = Field(
        None,
        description='Output only. A list of local inventories specific to different places. This field can be managed by ProductService.AddLocalInventories and ProductService.RemoveLocalInventories APIs if fine-grained, high-volume updates are necessary.',
    )
    ...
    primaryProductId: Optional[str] = Field(
        None,
    ...
    promotions: Optional[List[GoogleCloudRetailV2alphaPromotion]] = Field(
        None,
    ...
    rating: Optional[GoogleCloudRetailV2alphaRating] = Field(
        None, description='The rating of this product.'
    )
    retrievableFields: Optional[str] = Field(
        None,
    ...
    variants: Optional[List[GoogleCloudRetailV2alphaProduct]] = Field(
        None,
...
class GoogleCloudRetailV2alphaProductDetail(BaseModel):
    product: Optional[GoogleCloudRetailV2alphaProduct] = Field(
        None,
...
class GoogleCloudRetailV2alphaProductInlineSource(BaseModel):
    products: Optional[List[GoogleCloudRetailV2alphaProduct]] = Field(
        None,
...
class GoogleCloudRetailV2alphaProductInputConfig(BaseModel):
    bigQuerySource: Optional[GoogleCloudRetailV2alphaBigQuerySource] = Field(
        None, description='BigQuery input source.'
    )
    gcsSource: Optional[GoogleCloudRetailV2alphaGcsSource] = Field(
        None, description='Google Cloud Storage location for the input content.'
    )
    productInlineSource: Optional[GoogleCloudRetailV2alphaProductInlineSource] = Field(
        None, description='The Inline source for the input content for products.'
    )


class GoogleCloudRetailV2alphaSearchRequest(BaseModel):
    boostSpec: Optional[GoogleCloudRetailV2alphaSearchRequestBoostSpec] = Field(
        None,
    ...
    facetSpecs: Optional[List[GoogleCloudRetailV2alphaSearchRequestFacetSpec]] = Field(
        None,
    ...
    pageCategories: Optional[List[str]] = Field(
        None,
    ...
    relevanceThreshold: Optional[RelevanceThreshold] = Field(
        None,
    ...
    userInfo: Optional[GoogleCloudRetailV2alphaUserInfo] = Field(
        None, description='User information.'
    )
    variantRollupKeys: Optional[List[str]] = Field(
        None,
...
class GoogleCloudRetailV2alphaSearchResponseSearchResult(BaseModel):
    id: Optional[str] = Field(None, description='Product.id of the searched Product.')
    matchingVariantCount: Optional[int] = Field(
        None, description='The count of matched variant Products.'
    )
    matchingVariantFields: Optional[Dict[str, str]] = Field(
        None,
    ...
    personalLabels: Optional[List[str]] = Field(
        None,
    ...
    variantRollupValues: Optional[Dict[str, Any]] = Field(
        None,
...
class GoogleCloudRetailV2alphaSetInventoryRequest(BaseModel):
    allowMissing: Optional[bool] = Field(
        None,
    ...
    inventory: Optional[GoogleCloudRetailV2alphaProduct] = Field(
        None,
...
class GoogleCloudRetailV2alphaUserEvent(BaseModel):
    ...
    completionDetail: Optional[GoogleCloudRetailV2alphaCompletionDetail] = Field(
        None,
    ...
    entity: Optional[str] = Field(
        None,
        description='The entity for customers that may run multiple different entities, domains, sites or regions, for example, `Google US`, `Google Ads`, `Waymo`, `google.com`, `youtube.com`, etc. It is recommended to set this field to get better per-entity search, completion and prediction results.',
    )
    ...
    productDetails: Optional[List[GoogleCloudRetailV2alphaProductDetail]] = Field(
        None,
    ...
    purchaseTransaction: Optional[GoogleCloudRetailV2alphaPurchaseTransaction] = Field(
        None,
...
class GoogleCloudRetailV2alphaUserEventInlineSource(BaseModel):
    userEvents: Optional[List[GoogleCloudRetailV2alphaUserEvent]] = Field(
        None,
...
class GoogleCloudRetailV2alphaUserEventInputConfig(BaseModel):
    ...
    userEventInlineSource: Optional[GoogleCloudRetailV2alphaUserEventInlineSource] = (
        Field(
            None,
...
class GoogleCloudRetailV2alphaCompleteQueryResponse(BaseModel):
    ...
    completionResults: Optional[
        List[GoogleCloudRetailV2alphaCompleteQueryResponseCompletionResult]
    ] = Field(
        None,
        description='Results of the matching suggestions. The result list is ordered and the first result is top suggestion.',
    )
    recentSearchResults: Optional[
        List[GoogleCloudRetailV2alphaCompleteQueryResponseRecentSearchResult]
    ] = Field(
        None,
...
class GoogleCloudRetailV2alphaImportProductsRequest(BaseModel):
    ...
    inputConfig: Optional[GoogleCloudRetailV2alphaProductInputConfig] = Field(
        None, description='Required. The desired input location of the data.'
    )
    notificationPubsubTopic: Optional[str] = Field(
        None,
    ...
    skipDefaultBranchProtection: Optional[bool] = Field(
        None,
...
class GoogleCloudRetailV2alphaImportUserEventsRequest(BaseModel):
    ...
    inputConfig: Optional[GoogleCloudRetailV2alphaUserEventInputConfig] = Field(
        None, description='Required. The desired input location of the data.'
    )


class GoogleCloudRetailV2alphaListModelsResponse(BaseModel):
    models: Optional[List[GoogleCloudRetailV2alphaModel]] = Field(
...
class GoogleCloudRetailV2alphaPredictRequest(BaseModel):
    filter: Optional[str] = Field(
        None,
    ...
    pageToken: Optional[str] = Field(
        None, description='This field is not used; leave it unset.'
    )
    ...
    userEvent: Optional[GoogleCloudRetailV2alphaUserEvent] = Field(
        None,
...
class GoogleCloudRetailV2alphaSearchResponse(BaseModel):
    appliedControls: Optional[List[str]] = Field(
        None,
    ...
    correctedQuery: Optional[str] = Field(
        None,
    ...
    experimentInfo: Optional[List[GoogleCloudRetailV2alphaExperimentInfo]] = Field(
        None,
        description='Metadata related to A/B testing Experiment associated with this response. Only exists when an experiment is triggered.',
    )
    facets: Optional[List[GoogleCloudRetailV2alphaSearchResponseFacet]] = Field(
        None, description='Results of facets requested by user.'
    )
    invalidConditionBoostSpecs: Optional[
        List[GoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec]
    ] = Field(
        None,
    ...
    queryExpansionInfo: Optional[
        GoogleCloudRetailV2alphaSearchResponseQueryExpansionInfo
    ] = Field(None, description='Query expansion information for the returned results.')
    redirectUri: Optional[str] = Field(
        None,
    ...
    results: Optional[List[GoogleCloudRetailV2alphaSearchResponseSearchResult]] = Field(
        None, description='A list of matched items. The order represents the ranking.'
    )
    totalSize: Optional[int] = Field(
        None,
...
GoogleCloudRetailV2alphaProduct.model_rebuild()
